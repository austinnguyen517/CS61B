...
public class SimpleOomage implements Oomage {
    ...
    public boolean equals(Object o) {
        return (o.getClass() == this.getClass()) && this.red == ((SimpleOomage) o).red
                && this.green == ((SimpleOomage) o).green && this.blue == ((SimpleOomage) o).blue;
    }
    ...
    public int hashCode() {
        if (!USE_PERFECT_HASH) {
            ...
            return (red / 5) + 1000 * (green / 5) + 1000000 * (blue / 5);
        }
    }
